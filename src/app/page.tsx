    ...
    <div className="flex flex-col animate-in fade-in duration-500">
      <section className="relative h-[60vh] md:h-[80vh] w-full flex items-center justify-center text-center text-white">
        ...
        <div className="relative z-10 p-4">
          ...
          <p className="mt-4 text-lg md:text-2xl font-body max-w-3xl mx-auto drop-shadow-md">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature) => (
              <Card key={feature.title} className="text-center border-t-4 border-accent shadow-lg hover:shadow-xl transition-shadow duration-300">
                <CardHeader>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 text-center max-w-4xl">
           <h2 className="text-3xl md:text-4xl font-headline text-primary mb-4">A Lasting Impact</h2>
           <p className="text-lg text-muted-foreground mb-8">
             Explore the profound legacy of a leader dedicated to advancing education and empowering communities across Africa and beyond. His work continues to inspire new generations of thinkers, innovators, and leaders.
           </p>
